...
class saturator
{
    ...
    public:
         ...
         */
        void setControlLowerLimit( unsigned int idx, double _lowerLimit );
         ...
         */
        void setControlUpperLimit( unsigned int idx, double _upperLimit );
         ...
         */
        void setControlLowerRateLimit( unsigned int idx, double _lowerRateLimit );
         ...
         */
        void setControlUpperRateLimit( unsigned int idx, double _upperRateLimit );
